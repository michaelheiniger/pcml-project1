...
2. Functions files:
- implementations.py contains the 6 functions implementing the different regression methods.

- costs.py contains the Python functions used to compute the cost of the regression methods.
